...
suspend fun checkAndNotifyContracts(): Int {
    ...
    for (doc in toNotify) {
        ...
        val emailBody = """
            <p>Hei,</p>
            <p>Dette er en påminnelse om at kontrakten til <strong>$name</strong> hos <strong>$clientStr</strong> utløper om <strong>$warningDays dager</strong> ($contractEndFormatted).</p>
